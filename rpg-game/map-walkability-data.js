...
// v3: QAワークフロー反映（闇市の東出口到達修正・地下=中央帯に絞り上下機械帯を除外・庁舎=左右対称化）。

window.MAP_WALKABILITY_DEFAULTS = {
  "deep_tunnel": {
    walkableRects: [ { x: 45, y: 100, width: 710, height: 260 }, { x: 739, y: 189, width: 61, height: 222 }, { x: 289, y: 395, width: 222, height: 35 } ]
  },
  "deep_tunnel_2": {
